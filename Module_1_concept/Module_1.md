...
System. out .println( "Peach" ); ```  | Apple Peach |

| 2  | FOR loop | Classic for loop Uses an index to go throught the array | Easy to code      | Verbose code  Not always easy to read  Slower than other method | NO        | First time to make the code work  Always refactor | ```
for  (int i = 0; i < 10 ; i++) {  
